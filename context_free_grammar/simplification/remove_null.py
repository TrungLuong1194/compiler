        ...
        while flag:
            ...
            for i in range(len(self.grammar.production_rules)):
                if self.grammar.production_rules[i].right_side == 'e' and \
                        self.grammar.production_rules[i].left_side not in null_list:
                    null_list.append(self.grammar.production_rules[i].left_side)
            ...
            for i in range(len(null_list)):
                for j in range(len(self.grammar.production_rules)):
                    ...
                    if null_list[i] in right_side_of_rule_j:
                        ...
                        for k in range(len(right_side_of_rule_j)):
                            if right_side_of_rule_j[k] == null_list[i]:
                                index.append(k)
                        ...
                        for k in range(len(union)):
                            new_right_side = function.remove_string_by_index(
                                self.grammar.production_rules[j].right_side,
                                union[k]
                            )

                            if new_right_side not in list_right_side_of_left_symbol_of_rule_j:
            ...
            for i in range(len(self.grammar.production_rules)):
                if self.grammar.production_rules[i].right_side == 'e':
                    flag = True
