...
def concat(nfa1, nfa2):
    ...
    result.set_vertex(nfa1.get_vertex_count() + nfa2.get_vertex_count() - 1)
    ...
    result.set_final_state(nfa1.get_vertex_count() + nfa2.get_vertex_count() - 2)
...
def kleene(nfa):
    ...
    result.set_transition(nfa.get_vertex_count(), nfa.get_vertex_count() + 1, 'eps')
...
def union(nfa1, nfa2):
    ...
    result.set_transition(0, nfa1.get_vertex_count() + 1, 'eps')
    ...
    result.set_transition(
        nfa1.get_vertex_count() + nfa2.get_vertex_count(),
        nfa1.get_vertex_count() + nfa2.get_vertex_count() + 1,
        'eps')
